<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" class="space-y-6">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input id="name" class="block w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-sm focus:ring-info focus:border-info transition-colors placeholder:text-slate-400" type="text" name="name" value="{{ old('name') }}" required autofocus autocomplete="name" placeholder="John Doe" />
            </div>
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input id="email" class="block w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-sm focus:ring-info focus:border-info transition-colors placeholder:text-slate-400" type="email" name="email" value="{{ old('email') }}" required autocomplete="username" placeholder="name@company.com" />
            </div>
    ...
    <div class="mt-8 pt-8 border-t border-slate-100 text-center">
        <p class="text-sm text-textMuted">
            ...
            <a href="{{ route('login') }}" class="font-bold text-slate-900 hover:text-info transition-colors">Sign in here</a>
        </p>
    </div>
</x-guest-layout>
